    ...
    public override List<Tooltip> GetTooltips()
    {
        ...
        [
            new GlossaryTooltip("objecttooltip.megaasteroid")
            {
                ...
                IsWideIcon = true,
                Title = ModEntry.Instance.Localizations.Localize(["Weth", "object", "MegaAsteroid", "name"]),
                TitleColor = Colors.midrow,
                Description = ModEntry.Instance.Localizations.Localize(["Weth", "object", "MegaAsteroid", "desc"]),
            },
            new GlossaryTooltip("objecttooltip.giantasteroid")
            {
                Icon = ModEntry.Instance.SprGiantAsteroidIcon,
                IsWideIcon = true,
                Title = ModEntry.Instance.Localizations.Localize(["Weth", "object", "GiantAsteroid", "name"]),
                TitleColor = Colors.midrow,
                Description = ModEntry.Instance.Localizations.Localize(["Weth", "object", "GiantAsteroid", "desc"]),
            },
            .. base.GetTooltips(),
        ];
        return tooltips;
