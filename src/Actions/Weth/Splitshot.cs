    ...
    public override List<Tooltip> GetTooltips(State s)
    {
        ...
        if (piercing)
        {
            tooltips.Add(new GlossaryTooltip("actiontooltip.piercingsplitshot")
            {
                ...
                Title = ModEntry.Instance.Localizations.Localize(["Weth", "action", "Splitshot", "pierceName"]),
                TitleColor = Colors.action,
                Description = ModEntry.Instance.Localizations.Localize(["Weth", "action", "Splitshot", "pierceDesc"])
        ...
        else
        {
            tooltips.Add(new GlossaryTooltip("actiontooltip.splitshot")
            {
                ...
                Title = ModEntry.Instance.Localizations.Localize(["Weth", "action", "Splitshot", "name"]),
                TitleColor = Colors.action,
                Description = ModEntry.Instance.Localizations.Localize(["Weth", "action", "Splitshot", "desc"])
