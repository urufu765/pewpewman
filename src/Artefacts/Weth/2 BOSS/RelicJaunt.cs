...
public class TerminusJaunt : TheTerminus
{
    ...
    public override List<Tooltip>? GetExtraTooltips()
    {
        return Mode switch
        {
            ...
            {
                Description = ModEntry.Instance.Localizations.Localize(["Weth", "artifact", "Tooltips", "JauntActive"])
            }],
            Terminus.Inactive => [new GlossaryTooltip("terminusjaunt.inactive")
            {
                Description = ModEntry.Instance.Localizations.Localize(["Weth", "artifact", "Tooltips", "JauntInactive"])
            }],
            Terminus.Reward => [new GlossaryTooltip("terminusjaunt.reward")
            {
                Description = ModEntry.Instance.Localizations.Localize(["Weth", "artifact", "Tooltips", "JauntReward"])
            }],
            Terminus.AltReward => [new GlossaryTooltip("terminusjaunt.altreward")
            {
                Description = ModEntry.Instance.Localizations.Localize(["Weth", "artifact", "Tooltips", "JauntAltReward"])
            }],
