    ...
    public override CardData GetData(State state)
    {
        return upgrade switch
        {
            Upgrade.B => new CardData
            {
                ...
                description = string.Format(ModEntry.Instance.Localizations.Localize(["Weth", "card", "Uncommon", "Discovery", "desc"]), 2),
            },
            Upgrade.A => new CardData
            {
                ...
                exhaust = true,
                artOverlay = ModEntry.Instance.WethUncommon,
                description = string.Format(ModEntry.Instance.Localizations.Localize(["Weth", "card", "Uncommon", "Discovery", "descA"]), 3),
            },
            _ => new CardData
            {
                cost = 0,
                exhaust = true,
                artOverlay = ModEntry.Instance.WethUncommon,
                description = string.Format(ModEntry.Instance.Localizations.Localize(["Weth", "card", "Uncommon", "Discovery", "desc"]), 3),
            }
        };
    }
}