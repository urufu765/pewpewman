...
public class MilkSoda : Card, IRegisterable
{
    ...
    public static void Register(IPluginPackage<IModManifest> package, IModHelper helper)
    {
        helper.Content.Cards.RegisterCard(new CardConfiguration
        {
            ...
            Name = ModEntry.Instance.AnyLocalizations.Bind(["Weth", "card", "Common", "MilkSoda", "name"]).Localize,
            ...
            ModEntry.Instance.KokoroApi.V2.SpoofedActions.MakeAction(
                new APseudoPulsedriveGiver
                {
                    ...
                    descriptions = [
                        ...
                        ("milksodaWarning", ModEntry.Instance.Localizations.Localize(["Weth", "card", "Common", "MilkSoda", "descf"])),
    ...
    public override CardData GetData(State state)
    {
        return upgrade switch
        {
            _ => new CardData
            {
                ...
                art = GetSprite(),
                // description = string.Format(ModEntry.Instance.Localizations.Localize(["Weth", "card", "Common", "MilkSoda", GetDescription()]), PulsedrivesAcquired)
            }
        };
    }
    ...
    private string? GetDescription()
    {
        ...
        {
            return ModEntry.Instance.Localizations.Localize(["Weth", "card", "Common", "MilkSoda", "descf"]);  // Warning description
        }
        if (Used)
        {
            return ModEntry.Instance.Localizations.Localize(["Weth", "card", "Common", "MilkSoda", "descu"]);  // Used description
        }
        if (Exploded)
        {
            return ModEntry.Instance.Localizations.Localize(["Weth", "card", "Common", "MilkSoda", "desce"]);  // Exploded description
        }
        return null;
    }
    ...
    {
        return string.Format(ModEntry.Instance.Localizations.Localize(["Weth", "card", "Common", "MilkSoda", upgrade switch {
            Upgrade.A => "desca",
            Upgrade.B => "descb",
            _ => "desc"
