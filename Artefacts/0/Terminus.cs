...
public class TheTerminus : Artifact
{
    ...
    public override List<Tooltip>? GetExtraTooltips()
    {
        return Mode switch
        {
            ...
            {
                Description = ModEntry.Instance.Localizations.Localize(["artifact", "Tooltips", "TerminusReward"])
            }],
            Terminus.AltReward => [new GlossaryTooltip("terminustt.altreward")
            {
                Description = ModEntry.Instance.Localizations.Localize(["artifact", "Tooltips", "TerminusAltReward"])
            }],
